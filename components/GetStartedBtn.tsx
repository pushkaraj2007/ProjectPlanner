...
const GetStarted = () => {
    ...
    if(status === 'authenticated'){
        return (
            <Link href={'/dashboard'} className="bg-blue-700 hover:bg-blue-600 text-white flex items-center px-6 py-4 mt-6 md:mt-8 text-xl font-semibold rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition duration-300">
